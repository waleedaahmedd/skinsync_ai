...
class ConsultationPaymentScreen extends ConsumerStatefulWidget {
  static const routeName = '/consultation_payment_screen';

  const ConsultationPaymentScreen({super.key});

  @override
  ConsumerState<ConsultationPaymentScreen> createState() => _ConsultationPaymentScreenState();
}
