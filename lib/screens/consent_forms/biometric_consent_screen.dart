...
class _BiometricConsentScreenState extends ConsumerState<BiometricConsentScreen> {
  ...
  Future<void> _submitConsent() async {
    ...
    try {
      ...
      double renderWidth = pageWidth;
      double renderHeight = (imageHeight * pageWidth) / imageWidth;
      
      // If the image is taller than the page, we might need multiple pages or scale it down
      // For simplicity, we'll draw it on one page, but in a real app, you might want to split it.
