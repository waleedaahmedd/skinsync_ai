...
class _ArFaceModelPreviewScreenState
  ...
  /// Finds the checkout entry (treatment + its selected areas) for a given
  /// treatment id. Returns null if that treatment has no selections yet.
  SelectedTreatmentAndAreasModel? _entryForTreatment(
    ...
    for (final e in list) {
      if (e.treatment.id == treatmentId) return e;
    }
    return null;
  }
                              ...
                              Consumer(
                                builder: (context, ref, _) {
                                  ...
                                  final selectedTreatment =
                                      checkoutState.selectedTreatments;
                                  if (selectedTreatment == null) {
