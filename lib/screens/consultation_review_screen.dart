...
class ConsultationReviewScreen extends ConsumerWidget {
  static const routeName = '/consultation_review_screen';

  const ConsultationReviewScreen({super.key});
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            // Continuous to payments selection screen
            Container(
              padding: EdgeInsets.symmetric(horizontal: 24.w, vertical: 20.h),
              decoration: BoxDecoration(
                color: Colors.white,
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(
                      context,
                      ConsultationPaymentScreen.routeName,
                    );
                  },
